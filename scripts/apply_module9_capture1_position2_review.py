"""Validate and apply the persisted Module 9 Position 2 inspection decision."""
...
from export_module9_capture1_position2 import (
    FIELD_KEY,
    LABEL_PATH,
    OUTPUT_DIR,
    PROJECT_ROOT,
...
DECISION_PATH = OUTPUT_DIR / "capture1_position2_roi_review.json"
RECEIPT_PATH = OUTPUT_DIR / "capture1_position2_roi_review_applied.json"
